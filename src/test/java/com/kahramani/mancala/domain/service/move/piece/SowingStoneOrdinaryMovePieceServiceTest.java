...
public class SowingStoneOrdinaryMovePieceServiceTest {

    private SowingStoneOrdinaryMovePieceService sowingStoneOrdinaryMovePieceService;

    @Before
    public void setUp() {
        sowingStoneOrdinaryMovePieceService = new SowingStoneOrdinaryMovePieceService();
    }

    @Test
    public void should_sow_one_stone_to_pit() {
        ...
        sowingStoneOrdinaryMovePieceService.makeMovePiece(pitList, targetPit);
